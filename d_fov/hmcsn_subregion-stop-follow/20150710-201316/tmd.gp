...
set output "100_d_fov_vs_tmd.eps"
#set terminal qt font "Times New Roman, 20"
#set xlabel "{/SimSun=20 空洞数量}"
set xlabel "Length of Field of View"
set xrange [6:15]
set xtics 1
set mxtics 1
...
plot "d_fov-grid_vs_tmd" w lp lt 1 lw 2 pt 5 ps 2 title "Relay", \
     "d_fov-m_vs_tmd" w lp lt 2 lw 2 pt 2 ps 2 title "Direct"
set output
